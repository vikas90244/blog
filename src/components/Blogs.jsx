...
const Blogs = () => {
 const {fetchBlogs, deleteBlog, updateBlog, startEditing, cancelEditing, blogs, setBlogs, setEditing, editing, updatedTitle,updatedBody,setUpdatedBody, setUpdatedTitle, updatedTitleColor,setUpdatedTitleColor}=useContext(BlogContext);
           ...
           
            {
              blog.id===editing ? (
                <div className='flex flex-col gap-2'>
                  ...
                  <input
                  type="color"
                  className='rounded-md ddcursor-pointer'
                ...
                <button 
                className='px-3 py-1 bg-green-600 text-white font-medium rounded-md' onClick={()=>updateBlog(blog.id)}> 
                  Update
                  </button>
                  <button
                ...
                <h3
                 ...
                 className={`font-medium px-2 py-2 border-x border-t  bor rounded-t-md`}>{blog.title}</h3>
               <div
              style={{ backgroundColor: lightenColor(blog.title_color, 0.15)}}
               ...
               />
                ...
                <button className='px-3 mt-2 rounded-md text-blue-600 ' onClick={()=>startEditing(blog)}> 
